...
def initialize_population(population_size, min_value, max_value, num_genes):
    return [[random.uniform(min_value, max_value) for _ in range(num_genes)] for _ in range(population_size)]
...
def genetic_algorithm(objective_function, population_size, min_value, max_value, generations, tournament_size, mutation_rate, a, b, c):
    ...
    # Initialization
    population = initialize_population(population_size, min_value, max_value, num_genes)
    for generation in range(generations):
        # Evaluation
        fitness_values = [objective_function(genes[0], a, b, c) for genes in population]
        # Selection
